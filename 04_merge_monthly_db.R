...
db.tucker <- readRDS("DATA/MoveTraitsData/Tucker/tucker_monthly.sum_20260521.rds")
...
monthly.db_filtered <- monthly.db_filtered |> 
  dplyr::select("study_id","individual_id","individual_local_identifier",
               ...
               ,"source", "month","year",
                ...
                "n1h":"dmax24h.05","n.mcp24h.days":"mcp24h.05","n.iou24h.days":"iou24h.05",
