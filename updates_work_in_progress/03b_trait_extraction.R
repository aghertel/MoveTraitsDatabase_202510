...
sum.ind.d1h <- f_sum.ind.d1h(d1h[,c("individual_id","t_","d1h")])
sum.monthly.ind.d1h <- f_sum.monthly.ind.d1h(d1h)

## ----Maximum 24hr displacement-------------------------------------------------------------
dmax24 <- calc_dmax24h(animlocs.1hourly, dggs.10, dggs.1)
sum.ind.dmax24h <- f_sum.ind.dmax24h(dmax24)
sum.monthly.ind.dmax24h <- f_sum.monthly.ind.dmax24h(dmax24)

## ----24hr displacement distance-------------------------------------------------------------
d24h <- calc_d24h(animlocs.daily, dggs.10, dggs.1)
sum.ind.d24h <- f_sum.ind.d24h(d24h[,c("individual_id","t_","d24h")])
